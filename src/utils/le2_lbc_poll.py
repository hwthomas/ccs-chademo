#  File le2_lbc_poll.py  Sends commands to the LELink2 dongle to
...
async def lbc_poll_loop(ble: BLE_client):  # Builds and sends lbc Commands
    ...
    cmd = b"ATZ\r"          # finally send a reset to the elm_327 dongle
    await send_cmd(ble, cmd)
...
async def main():
    ...
    WRITE_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"     # ['read', 'write', 'notify']
    READ_UUID = "0000ffe1-0000-1000-8000-00805f9b34fb"      # ['read', 'write', 'notify']
    ...
    try:
        ...
        print("LELink2 device connected...")
        await ble.setup_chars(WRITE_UUID, READ_UUID, "rw", WRITE_WITH_RESPONSE)
        print("Device characteristics set up...")
