# File le2_terminal.py. Set up to communicate with OBDBLE device at address "90:59:AF:26:A4:54" 
#
import sys
import time
import asyncio
...
async def ble_startup():
    print("Starting program le2_terminal.py to query Leaf Tekna+ \n")

    # Connect to BLE device with the following parameters
    # PROSCAN = "66:1E:87:02:42:D1"
    # LELINK2 = "90:59:AF:26:A4:54"
    ADAPTER =       "hci0"
    DEVICE  =  "90:59:AF:26:A4:54"                          # address of LELink2 dongle
